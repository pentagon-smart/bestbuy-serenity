...
public class StoreCURDTest extends TestBase {
    ...
    static String address = "Alconbury Close";
    static String address2 = "Warringtone";
    static String city = "Manchester";
    static String state = "Chesire";
    static String zip = "55305";
    static int lat = 123466;
    static int lng = 7894566;
    static String hours = "20";
